...
const utilityClasses = {
  [THEME_MODE.DARK]: {
    ...
    'primary-button': 'inline-flex items-center justify-center rounded-xl bg-[#14b8a6] px-4 py-2 font-medium text-white transition hover:bg-[#0d9488] focus:outline-none focus:ring-2 focus:ring-[#22d3ee]/60',
  ...
  [THEME_MODE.LIGHT]: {
    ...
    'primary-button': 'inline-flex items-center justify-center rounded-xl bg-sky-500 px-4 py-2 font-medium text-white transition hover:bg-sky-600 focus:outline-none focus:ring-2 focus:ring-cyan-400/60',
